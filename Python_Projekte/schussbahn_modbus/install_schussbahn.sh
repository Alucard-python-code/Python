...
# Assign installation permissions command: 
# chmod +x /home/bahn_2/Schussbahn_app/install_schussbahn.sh
# Run install command: 
# ./home/bahn_2/Schussbahn_app/install_schussbahn.sh

# ====================================================================
# AUTOMATISCHES EINRICHTUNGS-SKRIPT FÜR DIE SCHUSSBAHN-APP (1024x600)
# ====================================================================
